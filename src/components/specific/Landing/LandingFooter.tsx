...
export const LandingFooter: React.FC<LandingFooterProps> = ({ onNavigateLegal }) => {
  ...
  const handleLegalClick = (tab: LegalTabKey) => {
    if (onNavigateLegal) {
      ...
      window.location.href = `/terms?tab=${tab}`;
    }
  };
        ...
        <View style={[styles.topRow, isMobile && styles.topRowMobile]}>
          ...
          <View style={[styles.linksGrid, isMobile && styles.linksGridMobile]}>
            ...
            <View style={styles.linksCol}>
              ...
              <TouchableOpacity onPress={() => handleLegalClick('service')}>
                <Text style={styles.linkText}>서비스 이용약관</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => handleLegalClick('privacy')}>
                <Text style={[styles.linkText, styles.linkBold]}>개인정보 처리방침</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => handleLegalClick('paid')}>
                <Text style={styles.linkText}>유료서비스 및 환불규정</Text>
              </TouchableOpacity>
