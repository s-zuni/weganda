...
export const PAID_TERMS: LegalDocument = {
  id: 'paid',
  title: '우간다 유료서비스 이용 및 환불 규정',
  shortTitle: '유료서비스 및 환불 규정',
  effectiveDate: '2026년 9월 1일 시행',
  version: 'v1.0',
  summary:
    '본 규정은 우간다가 제공하는 프리미엄 유료 멤버십 ‘weganda+’ 정기구독 서비스의 이용 조건, 요금 결제, 7일 무료체험, 자동 갱신, 해지 및 청약철회/환불에 관한 제반 기준을 규정합니다. (Apple App Store 및 Google Play 인앱결제 정책 준수)',
  articles: [
    {
      articleNumber: '제1조 (목적 및 적용 범위)',
      title: '목적 및 적용 범위',
      paragraphs: [
        '1. 본 규정은 회사가 제공하는 유료 멤버십 ‘weganda+’(이하 ‘유료서비스’라 합니다)를 이용하는 회원과 회사 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.',
        '2. 본 규정에 명시되지 않은 사항은 우간다 서비스 이용약관 및 해당 결제 마켓(Apple App Store, Google Play Store)의 운영 정책을 따릅니다.',
      ],
    },
    {
