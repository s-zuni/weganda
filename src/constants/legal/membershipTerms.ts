...
export const MEMBERSHIP_TERMS: LegalDocument = {
  ...
  version: 'v1.0',
  summary:
    '본 약관은 우간다가 제공하는 프리미엄 유료 멤버십 ‘weganda+’ 정기구독 서비스의 이용 조건, 요금 결제, 30일 무료 체험, 자동 갱신, 해지 및 청약철회/환불에 관한 제반 기준을 규정합니다. (Apple App Store 및 Google Play 인앱결제 정책 준수)',
  articles: [
    {
    ...
    },
    {
      ...
      subList: [
        ...
        },
        {
          ...
          items: [
            '① 앱 커스텀 컬러 테마 자유 설정 (세이지, 더스티로즈, 차콜 등 프리미엄 8종 / 핑크, 네이비 무료 기본 제공)',
    ...
    {
      articleNumber: '제3조 (30일 무료 체험 프로모션)',
      title: '30일 무료 체험 프로모션',
      paragraphs: [
        '1. 회사는 최초로 weganda+를 구독하는 회원에게 ‘30일 무료 체험(Free Trial)’ 혜택을 1회에 한하여 제공할 수 있습니다.',
        '2. 무료 체험 기간 동안에는 요금이 청구되지 않으며, 무료 체험 종료 최소 24시간 전까지 구독을 취소하지 않으면 선택한 구독 요금(월 5,900~7,900원 등)이 자동으로 정기 결제됩니다.',
        '3. 회원은 기기 설정(Apple ID 또는 Google 계정)에서 언제든지 무료 체험 취소 및 구독 해지를 진행할 수 있습니다.',
      ],
      highlightBox: {
        title: '🎁 30일 무료 체험 및 자동 결제 주의사항',
        description:
          '무료 체험 종료 24시간 전까지 구독을 해지하시면 비용이 전혀 발생하지 않습니다. 30일 무료 체험 기간이 지나면 자동으로 정기 결제가 시작됩니다.',
        variant: 'coral',
      },
    },
    {
